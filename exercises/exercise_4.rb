...
puts "There are #{@mens_stores.count} stores that carry men's apparel"
...
puts "There are #{@womens_stores_under_1m.count} stores that carry women's apparel under $1M revenue"
